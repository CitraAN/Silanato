        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        <a href="{{ route('riwayat_kunjungan') }}" class="btn btn-primary d-flex justify-content-center h6">Riwayat Kunjungan</a>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-body">
                        <a href="{{ route('informasilainya') }}" class="btn btn-primary d-flex justify-content-center h6">Informasi Lainya</a>
                    </div>
                </div>
            </div>
        </div>
