            ...
            <div class="col-md-12">
                <div class="card mt-5">
                    <div class="card-body bg-danger">
                        <a href="https://youtube.com/channel/UCo1jnFg7XnnkGh-CiTtul8Q" class="h6 text-white">
                ...
                <div class="card mt-3">
                    <div class="card-body bg-primary">
                        <a href="https://twitter.com/narkotikalapas?s=21&t=AJ1apHoUWgJJ2Am2ekG1hA" class="h6 text-white">
                ...
                <div class="card mt-3">
                    <div class="card-body" style="background-color: rgb(214, 0, 214)">
                        <a href="https://instagram.com/lapas.narkotika.purwokerto?igshid=YmMyMTA2M2Y=" class="h6 text-white">
                ...
                <div class="card mt-3">
                    <div class="card-body" style="background-color: rgb(0, 86, 214)">
                        <a href="https://www.facebook.com/lapas.narkotika.purwokerto" class="h6 text-white">
                ...
                <div class="card mt-3">
                    <div class="card-body bg-success">
                        <a href="https://wa.me/081334735886" class="h6 text-white">
                ...
                <div class="card mt-3">
                    <div class="card-body bg-dark">
                        <a href="https://www.tiktok.com/@lps.narkotika.purwokerto?_t=8VW3pMR60fJ&_r=1" class="h6 text-white">
