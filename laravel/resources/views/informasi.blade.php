...
<body class="bg-primary">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-priy justify-content-sm-start fixed-top border-bottom border-dark">
                    ...
                    <div class="">
                        <div class="row">
                            <div class="col mt-3">
                                ...
                                <div class="form-group bg-white rounded">
                                    <a class="form-control" href="{{ route('informasi_lainya') }}">
                                        Informasi Lainnya
                                        <img src="{{ asset('logo/panah-removebg-preview.png')}}" alt="" height="24" class="d-inline-block align-text-top float-right">
                                    </a>
                                </div>
